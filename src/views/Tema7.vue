...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure.mb-5
      img(src='@/assets/curso/temas/img59.jpg', alt='Texto que describa la imagen')
    ...
    TabsB.my-5
      ...
      .py-4.py-md-5(titulo="Diseño" :icono="require('@/assets/curso/temas/img8.svg')")
        .row
          .col-lg-6
            figure.my-5
              img(src='@/assets/curso/temas/img60.svg', alt='Texto que describa la imagen' )
          .col-lg-6
            figure.my-5
              img(src='@/assets/curso/temas/img61.svg', alt='Texto que describa la imagen' )
        ...
        figure.mb-5
              img(src='@/assets/curso/temas/img62.svg', alt='Texto que describa la imagen' )
