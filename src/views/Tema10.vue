...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p Ingresar en la ruta del navegador a &nbsp;
      ...
      .row.justify-content-around.align-items-center
        ...
        .col
          .row.justify-content-between.align-items-center
            ...
            .col-sm-auto
              a.boton.color-acento-contenido(:href="obtenerLink('/downloads/DI_CF3_Funciones_clase_Math.pdf')" target="_blank")
                span Descargar
    ...
    TabsC.mb-5
      ...
      .py-3.py-md-4(titulo="Operadores lógicos")
        ...
        .row
          .col-lg-6
            figure
            img(src='@/assets/curso/temas8-13/img18.jpg', alt='')
    ...
    p En adelante se procura que exista al menos un comentario en cada código fuente empleado para ejemplificar los elementos constitutivos del lenguaje de programación JavaScript y puede hacer lo mismo durante la creación de los diferentes códigos.
    ...
    .row.mb-5
      .col-lg-6
        figure
            img(src='@/assets/curso/temas8-13/img21.jpg', alt='').m-auto
    ...
    .row.mb-5
      ...
      .col-lg-6
        p.mb-3 De acuerdo con la figura 9, no existe un contexto si no se cumple la condición de mayoría de edad a esta estructura se denomina #[strong CONDICIONAL SIMPLE].
    ...
    p.mt-3.mb-5 #[strong Ejemplo 1:] escribir un procedimiento que muestre siete (7) veces en pantalla la frase “Esto es un algoritmo”. Mostrar en pantalla la salida del ejercicio:

    .row.mb-5
      .col-lg-6
        figure
            img(src='@/assets/curso/temas8-13/img23.jpg', alt='').m-auto
    ...
    .row.mb-5
      .col-lg-6
        figure
            img(src='@/assets/curso/temas8-13/img24.jpg', alt='').m-auto
    ...
    .row.mb-5
      .col-lg-7
        figure.mb-sm-3
            img(src='@/assets/curso/temas8-13/img55.jpg', alt='')
    ...
    .row.mb-5
      .col-lg-6
        figure.mb-sm-3
            img(src='@/assets/curso/temas8-13/img26.jpg', alt='').m-auto
    ...
    .row.mb-5
      .col-lg-6
        figure.mb-sm-3
            img(src='@/assets/curso/temas8-13/img27.jpg', alt='').m-auto
    ...
    figure.mb-5
            img(src='@/assets/curso/temas8-13/img28.jpg', alt='' style="width:367px").m-auto
    ...
    .row.mb-5
      .col-lg-6
        figure.mb-sm-3
            img(src='@/assets/curso/temas8-13/img30.jpg', alt='').m-auto
    ...
    .row.mb-5
      .col-lg-6
        figure.mb-sm-3
            img(src='@/assets/curso/temas8-13/img31.jpg', alt='').m-auto
    ...
    figure.mb-5
      img(src='@/assets/curso/temas8-13/img32.jpg', alt='').m-auto
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
      div(titulo="Sentencia continue").p-5
        ...
        figure
          img(src='@/assets/curso/temas8-13/img33.jpg', alt='')
      ...
      div(titulo="Sentencia return").p-5
        ...
        figure
          img(src='@/assets/curso/temas8-13/img35.jpg', alt='')
    ...
    .row.my-5
      .col-lg-6
        figure.mb-sm-3
            img(src='@/assets/curso/temas8-13/img42.jpg', alt='').m-auto
