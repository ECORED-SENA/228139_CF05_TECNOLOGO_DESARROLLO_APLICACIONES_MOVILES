...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row
      .col-lg-4
        figure
          img(src='@/assets/curso/temas/img29.jpg', alt='Texto que describa la imagen')
      .col-lg-8
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul")
      ...
      .row(titulo="c. Contadores")
        ...
        figure.mb-3
          img(src='@/assets/curso/temas/img31.svg', alt='Texto que describa la imagen' style='width: 80%').m-auto
