  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Análisis y solución de problemas aplicando algoritmos
        p.mb-4 Fortalecer los aspectos conceptuales y prácticos sobre Algoritmos y codificación de algoritmos, con base en los temas estudiados en el componente formativo.
