...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p Para realizar las operaciones de asignación, lectura/escritura sobre un vector, se recomienda usar las estructuras repetitivas para, a través de ellas, manipular los índices correspondientes a las posiciones del arreglo.
    ...
    TabsB.my-5
      .py-4.py-md-5(titulo="Análisis" :icono ="require ('@/assets/curso/temas/img33.svg')")
        ul.lista-ul
            li
              i.fas.fa-circle
              span
      ...
      .py-4.py-md-5(titulo="Diseño" :icono="require('@/assets/curso/temas/img34.svg')")
        .row
          .col-lg-6
            figure.my-5
    ...
    .row
      .col-lg-6
        figure
              img(src='@/assets/curso/temas/img58.svg', alt='' )
