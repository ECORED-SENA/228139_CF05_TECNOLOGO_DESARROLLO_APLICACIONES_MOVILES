...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    figure.mb-5
      ...
      .contenedor-tarjetas
          .tarjeta-Avatar.mb-5
            img(src='@/assets/curso/temas/img53.svg' alt='AvatarTop' style='width: 136px')
            .tarjeta.tarjeta--amarilla
              p.text-center.m-auto
                b Unidimensionales:
                b-none de una dimensión, comparables con una lista de elementos.
          .tarjeta-Avatar.mb-5
            img(src='@/assets/curso/temas/img54.svg' alt='AvatarTop' style='width: 136px')
            .tarjeta.tarjeta--amarilla
              p.text-center.m-auto
      ...
      figure.mb-5
                img(src='@/assets/curso/temas/img55.svg', alt='' )
